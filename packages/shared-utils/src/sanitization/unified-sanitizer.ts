...
export function sanitizeLogData(
  data: unknown,
  options: { maskSensitive?: boolean; maxDepth?: number } = {},
): unknown {
...
export function sanitizeWithSafetyCheck(
  input: string,
  options: SanitizationOptions = {},
): ContentSafetyResult & { content?: string; wasBlocked?: boolean } {
...
export function allowedTagsFilter(
  html: string,
  allowedTags: string[] = [],
): string {
  if (!html || typeof html !== "string") {
