...
- Name: Responsive Design Testing >> Tablet Portrait (768x1024) >> Navigation responsiveness
- Location: C:\Users\Tyson\Desktop\Development Tools\nosytlabs-github-ready\tests\responsive.spec.js:29:7
...
Locator: locator('nav a, .nav-link').first()
Expected: visible
Received: hidden
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('nav a, .nav-link').first()
    8 × locator resolved to <a role="menuitem" href="/services" class="nav-link " data-astro-cid-rgfl3gnm="" data-tooltip="Web development, AI solutions, and digital services">…</a>
      - unexpected value "hidden"

    at C:\Users\Tyson\Desktop\Development Tools\nosytlabs-github-ready\tests\responsive.spec.js:58:44
```
