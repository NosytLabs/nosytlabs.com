...
- Name: Resource Loading and Performance >> Network request optimization
- Location: C:\Users\Tyson\Desktop\Development Tools\nosytlabs-github-ready\tests\resource-loading.spec.js:280:3
...
Call log:
  - navigating to "http://localhost:3000/", waiting until "load"
    ...
    at C:\Users\Tyson\Desktop\Development Tools\nosytlabs-github-ready\tests\resource-loading.spec.js:303:16
```
...
> 303 |     await page.goto('/');
  ...
  345 |     }
  346 |
  347 |     // Should not have excessive requests
  348 |     expect(allRequests.length, 'Should not have excessive network requests').toBeLessThan(100);
  349 |   });
  350 | });
```