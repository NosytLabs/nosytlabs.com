...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    // Validate required fields for project inquiry
    const requiredFields = ['name', 'email', 'projectType', 'projectDescription', 'budget', 'timeline'];
    ...
    const response = await fetch(`${EXPRESS_API_URL}/api/contact/project`, {
      method: 'POST',
      headers: {
