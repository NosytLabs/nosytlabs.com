...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const sounds = {
    ...
    shot: new Audio('/sounds/duck-hunt/shot.mp3'),
    hit: new Audio('/sounds/win95/ding.wav'),
    miss: new Audio('/sounds/win95/chord.wav'),
    roundClear: new Audio('/sounds/duck-hunt/level-up.mp3'),
    gameOver: new Audio('/sounds/win95/chord.wav'),
    dogLaugh: new Audio('/sounds/funny-quack.mp3'),
    dogBark: new Audio('/sounds/duck-hunt/quack.mp3'),
    reload: new Audio('/sounds/win95/ding.wav'),
    emptyGun: new Audio('/sounds/win95/chord.wav'),
    duckFall: new Audio('/sounds/duck-hunt/fall.mp3'),
