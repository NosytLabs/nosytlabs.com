...
elements.contactForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        handleError(error, 'Form submission', ErrorSeverity.MEDIUM, ErrorCategory.USER_INPUT); handleError(error, 'Form submission', ErrorSeverity.MEDIUM, ErrorCategory.USER_INPUT); showNotification('Error submitting form. Please try again.', 'error');
    } finally {
