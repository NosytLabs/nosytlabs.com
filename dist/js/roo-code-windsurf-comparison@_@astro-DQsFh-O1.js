...
const f = createComponent((r, v, y) => {
  const i = "Roo Code vs Windsurf: AI Coding Assistants Compared - NosytLabs", o = "A detailed comparison of Roo Code and Windsurf, two leading AI coding assistants, with insights on which one might be right for your development workflow.", n = "May 1, 2025", d = "Tycen", l = "12 min read", m = "AI Tools", c = `// Roo Code generated this function to process and validate form data
...
}`, u = `// Windsurf generated this function to process and validate form data
function validateForm(form) {
  ...
  return renderTemplate`${renderComponent(r, "BaseLayout", h, { title: i, description: o, "data-astro-cid-d5mmkjyn": true }, { default: (e) => renderTemplate` ${maybeRenderHead()}<article class="blog-post container mx-auto px-4 py-12" data-astro-cid-d5mmkjyn> <header class="mb-12 text-center" data-astro-cid-d5mmkjyn> <h1 class="text-4xl md:text-5xl font-bold mb-4 text-gray-800 dark:text-white" data-astro-cid-d5mmkjyn>
Roo Code vs Windsurf: <span class="text-accent" data-astro-cid-d5mmkjyn>AI Coding Assistants Compared</span> </h1> <div class="flex flex-wrap justify-center items-center gap-4 text-sm text-gray-600 dark:text-gray-400" data-astro-cid-d5mmkjyn> <span class="flex items-center" data-astro-cid-d5mmkjyn> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-d5mmkjyn> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-astro-cid-d5mmkjyn></path> </svg> ${n} </span> <span class="flex items-center" data-astro-cid-d5mmkjyn> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-d5mmkjyn> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-astro-cid-d5mmkjyn></path> </svg> ${d} </span> <span class="flex items-center" data-astro-cid-d5mmkjyn> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-d5mmkjyn> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-d5mmkjyn></path> </svg> ${l} </span> <span class="flex items-center" data-astro-cid-d5mmkjyn> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-d5mmkjyn> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" data-astro-cid-d5mmkjyn></path> </svg> ${m} </span> </div> </header> <div class="prose prose-lg dark:prose-invert max-w-4xl mx-auto" data-astro-cid-d5mmkjyn> <p class="lead text-xl mb-8" data-astro-cid-d5mmkjyn>
...
</p> <div class="my-12" data-astro-cid-d5mmkjyn> ${renderComponent(e, "CodeDisplay", g, { title: "form-validation.js (Roo Code)", language: "javascript", code: c, dark: true, showLineNumbers: true, "data-astro-cid-d5mmkjyn": true })} <p class="text-sm text-center mt-2 text-gray-600 dark:text-gray-400" data-astro-cid-d5mmkjyn>Form validation function generated by Roo Code</p> </div> <h3 data-astro-cid-d5mmkjyn>Integration Capabilities</h3> <p data-astro-cid-d5mmkjyn>
...
</p> <div class="my-12" data-astro-cid-d5mmkjyn> ${renderComponent(e, "CodeDisplay", g, { title: "form-validation.js (Windsurf)", language: "javascript", code: u, dark: true, showLineNumbers: true, "data-astro-cid-d5mmkjyn": true })} <p class="text-sm text-center mt-2 text-gray-600 dark:text-gray-400" data-astro-cid-d5mmkjyn>Form validation function generated by Windsurf</p> </div> <h3 data-astro-cid-d5mmkjyn>Debugging Assistance</h3> <p data-astro-cid-d5mmkjyn>
...
}, "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/roo-code-windsurf-comparison.astro", void 0);
const $$file = "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/roo-code-windsurf-comparison.astro";
const $$url = "/blog/roo-code-windsurf-comparison.html";
const _page = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: f, file: $$file, url: $$url }, Symbol.toStringTag, { value: "Module" }));
const page = () => _page;
export {
  _page as _,
  page as p
