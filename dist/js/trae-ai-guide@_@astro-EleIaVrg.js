...
const m = createComponent((r, v, w) => {
  const s = "Trae AI: The Ultimate Developer's Companion - NosytLabs", o = "A comprehensive guide to Trae AI, the lightweight and powerful coding assistant that's revolutionizing development workflows.", i = "May 3, 2025", d = "Tycen", c = "10 min read", n = "AI Tools", l = `// Example of using Trae AI to optimize a sorting algorithm
...
function partition(arr, low, high, pivotIndex) {
  ...
  return renderTemplate`${renderComponent(r, "BaseLayout", h, { title: s, description: o, "data-astro-cid-c66ucdsg": true }, { default: (t) => renderTemplate` ${maybeRenderHead()}<article class="blog-post container mx-auto px-4 py-12" data-astro-cid-c66ucdsg> <header class="mb-12 text-center" data-astro-cid-c66ucdsg> <h1 class="text-4xl md:text-5xl font-bold mb-4 text-gray-800 dark:text-white" data-astro-cid-c66ucdsg>
Trae AI: <span class="text-accent" data-astro-cid-c66ucdsg>The Ultimate Developer's Companion</span> </h1> <div class="flex flex-wrap justify-center items-center gap-4 text-sm text-gray-600 dark:text-gray-400" data-astro-cid-c66ucdsg> <span class="flex items-center" data-astro-cid-c66ucdsg> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-c66ucdsg> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-astro-cid-c66ucdsg></path> </svg> ${i} </span> <span class="flex items-center" data-astro-cid-c66ucdsg> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-c66ucdsg> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-astro-cid-c66ucdsg></path> </svg> ${d} </span> <span class="flex items-center" data-astro-cid-c66ucdsg> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-c66ucdsg> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-c66ucdsg></path> </svg> ${c} </span> <span class="flex items-center" data-astro-cid-c66ucdsg> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-c66ucdsg> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" data-astro-cid-c66ucdsg></path> </svg> ${n} </span> </div> </header> <div class="prose prose-lg dark:prose-invert max-w-4xl mx-auto" data-astro-cid-c66ucdsg> <p class="lead text-xl mb-8" data-astro-cid-c66ucdsg>
...
</p> <div class="my-12" data-astro-cid-c66ucdsg> ${renderComponent(t, "CodeDisplay", g, { title: "optimized-sort.js", language: "javascript", code: l, dark: true, showLineNumbers: true, "data-astro-cid-c66ucdsg": true })} <p class="text-sm text-center mt-2 text-gray-600 dark:text-gray-400" data-astro-cid-c66ucdsg>Example of algorithm optimization with Trae AI assistance</p> </div> <h2 data-astro-cid-c66ucdsg>Real-World Applications</h2> <p data-astro-cid-c66ucdsg>
...
}, "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/trae-ai-guide.astro", void 0);
const $$file = "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/trae-ai-guide.astro";
const $$url = "/blog/trae-ai-guide.html";
const _page = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: m, file: $$file, url: $$url }, Symbol.toStringTag, { value: "Module" }));
const page = () => _page;
export {
  _page as _,
  page as p
