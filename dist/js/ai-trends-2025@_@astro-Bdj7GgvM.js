import { c as createComponent, r as renderComponent, e as renderTemplate, m as maybeRenderHead, b as addAttribute, u as unescapeHTML } from "./vendor-DUem_BGh.js";
import { h } from "./BaseLayout-HgcEqE4G.js";
import "./youtubeScraperUtil-CL4p1bpI.js";
const p = createComponent((n, m, h$1) => {
  const s = { title: "AI Trends to Watch in 2025", excerpt: "Exploring the cutting-edge developments in artificial intelligence that will shape the coming year.", date: "May 1, 2025", author: "Tycen", category: "Artificial Intelligence", image: "/images/blog/ai-trends-2025.jpg", tags: ["AI", "Machine Learning", "Technology Trends"], content: `
    <p class="lead">
  ...
  ` }, i = [{ id: "web-development-best-practices", title: "Web Development Best Practices", excerpt: "Key principles and techniques for building robust, scalable web applications.", date: "April 15, 2025", image: "/images/blog/web-dev.jpg" }, { id: "blockchain-applications", title: "Practical Blockchain Applications for Business", excerpt: "Real-world use cases of blockchain technology beyond cryptocurrencies.", date: "March 10, 2025", image: "/images/blog/blockchain.jpg" }, { id: "cybersecurity-essentials", title: "Cybersecurity Essentials for Modern Businesses", excerpt: "Critical security measures every business should implement to protect digital assets.", date: "February 28, 2025", image: "/images/blog/cybersecurity.jpg" }];
  return renderTemplate`${renderComponent(n, "BaseLayout", h, { title: `${s.title} - NosytLabs Blog`, description: s.excerpt }, { default: (r) => renderTemplate`  ${maybeRenderHead()}<div class="relative"> <div class="w-full h-96 overflow-hidden"> <img${addAttribute(s.image, "src")}${addAttribute(s.title, "alt")} class="w-full h-full object-cover"> </div> <div class="absolute inset-0 bg-black bg-opacity-50 flex items-center"> <div class="container mx-auto px-4"> <div class="max-w-3xl text-white"> <div class="flex items-center text-sm mb-4"> <span>${s.date}</span> <span class="mx-2">•</span> <span>${s.category}</span> </div> <h1 class="text-4xl md:text-5xl font-bold mb-4">${s.title}</h1> <div class="flex items-center"> <img src="/images/authors/tycen.jpg"${addAttribute(s.author, "alt")} class="w-10 h-10 rounded-full mr-4"> <span>By ${s.author}</span> </div> </div> </div> </div> </div>  <section class="py-16"> <div class="container mx-auto px-4"> <div class="flex flex-col lg:flex-row gap-12"> <!-- Main Content --> <div class="lg:w-2/3"> <article class="bg-white rounded-lg shadow-md p-8"> <!-- Tags --> <div class="flex flex-wrap gap-2 mb-8"> ${s.tags.map((e) => renderTemplate`<a${addAttribute(`/blog/tag/${e.toLowerCase().replace(/\s+/g, "-")}`, "href")} class="px-3 py-1 bg-gray-100 hover:bg-indigo-100 text-gray-700 hover:text-indigo-700 rounded-full text-sm transition-colors"> ${e} </a>`)} </div> <!-- Content --> <div class="prose prose-lg max-w-none">${unescapeHTML(s.content)}</div> <!-- Author Bio --> <div class="mt-12 pt-8 border-t border-gray-200"> <div class="flex items-center"> <img src="/images/authors/tycen.jpg"${addAttribute(s.author, "alt")} class="w-16 h-16 rounded-full mr-6"> <div> <h3 class="text-xl font-semibold mb-2">About ${s.author}</h3> <p class="text-gray-600">
...
Subscribe
</button> </form> </div> </div> </div> </div> </section>  <section class="py-16 bg-gray-50"> <div class="container mx-auto px-4"> <h2 class="text-3xl font-bold mb-8 text-center">More Articles You Might Like</h2> <div class="grid grid-cols-1 md:grid-cols-3 gap-8"> ${i.map((e) => renderTemplate`<article class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow"> <a${addAttribute(`/blog/${e.id}`, "href")}> <img${addAttribute(e.image, "src")}${addAttribute(e.title, "alt")} class="w-full h-48 object-cover"> </a> <div class="p-6"> <h3 class="text-xl font-semibold mb-2"> <a${addAttribute(`/blog/${e.id}`, "href")} class="hover:text-indigo-600 transition-colors">${e.title}</a> </h3> <p class="text-gray-600 mb-4">${e.excerpt}</p> <div class="flex items-center text-sm text-gray-500"> <span>${e.date}</span> </div> </div> </article>`)} </div> </div> </section> ` })}`;
}, "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/ai-trends-2025.astro", void 0);
const $$file = "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/ai-trends-2025.astro";
const $$url = "/blog/ai-trends-2025.html";
const _page = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: p, file: $$file, url: $$url }, Symbol.toStringTag, { value: "Module" }));
const page = () => _page;
export {
  _page as _,
  page as p
