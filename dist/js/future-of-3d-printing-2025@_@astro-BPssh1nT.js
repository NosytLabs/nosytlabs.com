import { c as createComponent, r as renderComponent, e as renderTemplate, m as maybeRenderHead, b as addAttribute } from "./vendor-DUem_BGh.js";
import { h } from "./BaseLayout-HgcEqE4G.js";
import { g } from "./CodeDisplay-Bv98STKa.js";
/* empty css                                         */
import "./youtubeScraperUtil-CL4p1bpI.js";
const b = createComponent((r, f, q) => {
  const t = "The Future of 3D Printing in 2025 and Beyond - NosytLabs", o = "Explore the latest advancements in 3D printing technology, from high-resolution resin printers to AI-assisted modeling and sustainable materials that are revolutionizing manufacturing.", n = "/images/blog/future-3d-printing.jpg", d = "May 12, 2025", l = "Tycen", c = "12 min read", u = "3D Printing", m = `// Example of AI-assisted 3D model optimization in JavaScript
...
console.log(\`Model optimized successfully. File size reduced by \${optimizationResult.optimizationMetadata.fileSizeReduction}%\`);`;
  return renderTemplate`${renderComponent(r, "BaseLayout", h, { title: t, description: o, "data-astro-cid-bq6svu34": true }, { default: (e) => renderTemplate` ${maybeRenderHead()}<article class="blog-post container mx-auto px-4 py-12" data-astro-cid-bq6svu34> <!-- Featured Image --> <div class="w-full h-96 overflow-hidden rounded-xl mb-8" data-astro-cid-bq6svu34> <img${addAttribute(n, "src")}${addAttribute(t, "alt")} class="w-full h-full object-cover" data-astro-cid-bq6svu34> </div> <header class="mb-12 text-center" data-astro-cid-bq6svu34> <h1 class="text-4xl md:text-5xl font-bold mb-4 text-gray-800 dark:text-white" data-astro-cid-bq6svu34>
The Future of <span class="text-accent" data-astro-cid-bq6svu34>3D Printing</span> in 2025 and Beyond
</h1> <div class="flex flex-wrap justify-center items-center gap-4 text-sm text-gray-600 dark:text-gray-400" data-astro-cid-bq6svu34> <span class="flex items-center" data-astro-cid-bq6svu34> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-bq6svu34> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-astro-cid-bq6svu34></path> </svg> ${d} </span> <span class="flex items-center" data-astro-cid-bq6svu34> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-bq6svu34> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-astro-cid-bq6svu34></path> </svg> ${l} </span> <span class="flex items-center" data-astro-cid-bq6svu34> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-bq6svu34> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-bq6svu34></path> </svg> ${c} </span> <span class="flex items-center" data-astro-cid-bq6svu34> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-bq6svu34> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" data-astro-cid-bq6svu34></path> </svg> ${u} </span> </div> </header> <div class="prose prose-lg dark:prose-invert max-w-4xl mx-auto" data-astro-cid-bq6svu34> <p class="lead text-xl mb-8" data-astro-cid-bq6svu34>
...
</p> <ul data-astro-cid-bq6svu34> <li data-astro-cid-bq6svu34>Optimize models for specific printers and materials</li> <li data-astro-cid-bq6svu34>Generate internal support structures that minimize material usage while maintaining strength</li> <li data-astro-cid-bq6svu34>Predict and compensate for warping and shrinkage</li> <li data-astro-cid-bq6svu34>Identify potential print failures before they occur</li> </ul> <div class="my-12" data-astro-cid-bq6svu34> ${renderComponent(e, "CodeDisplay", g, { title: "model-optimizer.js", language: "javascript", code: m, dark: true, showLineNumbers: true, "data-astro-cid-bq6svu34": true })} <p class="text-sm text-center mt-2 text-gray-600 dark:text-gray-400" data-astro-cid-bq6svu34>Example of AI-assisted 3D model optimization code</p> </div> <h3 data-astro-cid-bq6svu34>Sustainable and Functional Materials</h3> <p data-astro-cid-bq6svu34>
...
}, "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/future-of-3d-printing-2025.astro", void 0);
const $$file = "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/future-of-3d-printing-2025.astro";
const $$url = "/blog/future-of-3d-printing-2025.html";
const _page = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: b, file: $$file, url: $$url }, Symbol.toStringTag, { value: "Module" }));
const page = () => _page;
export {
  _page as _,
  page as p
