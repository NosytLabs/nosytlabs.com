...
import { g as g$1 } from "./CodeDisplay-Bv98STKa.js";
/* empty css                               */
import "./youtubeScraperUtil-CL4p1bpI.js";
const g = createComponent(async (r, m, f) => {
  const s = "Cursor AI Review: The Future of Coding Assistants - NosytLabs", o = "An in-depth review of Cursor AI, the revolutionary coding assistant that's changing how developers write code in 2025.", n = "May 5, 2025", d = "Tycen", i = "8 min read", c = "AI Tools", l = `// Example of using Cursor AI to generate a React component
...
export default DataFetcher;`;
  return renderTemplate`${renderComponent(r, "BaseLayout", h, { title: s, description: o, "data-astro-cid-dvur3np5": true }, { default: async (t) => renderTemplate` ${maybeRenderHead()}<article class="blog-post container mx-auto px-4 py-12" data-astro-cid-dvur3np5> <header class="mb-12 text-center" data-astro-cid-dvur3np5> <h1 class="text-4xl md:text-5xl font-bold mb-4 text-gray-800 dark:text-white" data-astro-cid-dvur3np5>
Cursor AI Review: <span class="text-accent" data-astro-cid-dvur3np5>The Future of Coding Assistants</span> </h1> <div class="flex flex-wrap justify-center items-center gap-4 text-sm text-gray-600 dark:text-gray-400" data-astro-cid-dvur3np5> <span class="flex items-center" data-astro-cid-dvur3np5> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-dvur3np5> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" data-astro-cid-dvur3np5></path> </svg> ${n} </span> <span class="flex items-center" data-astro-cid-dvur3np5> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-dvur3np5> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" data-astro-cid-dvur3np5></path> </svg> ${d} </span> <span class="flex items-center" data-astro-cid-dvur3np5> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-dvur3np5> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-dvur3np5></path> </svg> ${i} </span> <span class="flex items-center" data-astro-cid-dvur3np5> <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-dvur3np5> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" data-astro-cid-dvur3np5></path> </svg> ${c} </span> </div> </header> <div class="prose prose-lg dark:prose-invert max-w-4xl mx-auto" data-astro-cid-dvur3np5> <p class="lead text-xl mb-8" data-astro-cid-dvur3np5>
...
</p> <div class="my-12" data-astro-cid-dvur3np5> ${renderComponent(t, "CodeDisplay", g$1, { title: "data-fetcher.jsx", language: "javascript", code: l, dark: true, showLineNumbers: true, theme: "professional", "data-astro-cid-dvur3np5": true })} <p class="text-sm text-center mt-2 text-gray-600 dark:text-gray-400" data-astro-cid-dvur3np5>Example of a React component generated with Cursor AI assistance</p> </div> <h2 data-astro-cid-dvur3np5>Real-World Performance</h2> <p data-astro-cid-dvur3np5>
...
}, "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/cursor-ai-review.astro", void 0);
const $$file = "C:/Users/Tyson/Desktop/Development Tools/nosytlabs-github-ready/src/pages/blog/cursor-ai-review.astro";
const $$url = "/blog/cursor-ai-review.html";
const _page = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({ __proto__: null, default: g, file: $$file, url: $$url }, Symbol.toStringTag, { value: "Module" }));
const page = () => _page;
export {
  _page as _,
  page as p
