/* empty css                              */import {c as createAstro,a as createComponent,r as renderTemplate,d as renderComponent,m as maybeRenderHead,b as addAttribute}from'../astro-6c4e0209.js';import {$ as $$BaseLayout}from'./3d-printing.astro-671fe4d5.js';import {f as fetchChannelData,a as fetchChannelVideos}from'./content-creation.astro-1a5d41dc.js';/* empty css                        */import'clsx';/* empty css                        *//* empty css                        *//* empty css                        *//* empty css                        */import {$ as $$GlitchText,a as $$AnimatedSection}from'./blog-page.astro-d865aee4.js';/* empty css                        */const featured = [
	{
		id: "dev-toolkit",
		title: "Dev Toolkit",
...
const $$url$4 = "";const index$4=/*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({__proto__:null,default:$$Index$4,file:$$file$4,url:$$url$4},Symbol.toStringTag,{value:'Module'}));const $$Astro$2 = createAstro("https://nosytlabs.com");
...
}, "C:/Users/Tyson/Downloads/nosytlabs-github-ready/src/components/admin/AdminSidebar.astro", void 0);const $$Astro$1 = createAstro("https://nosytlabs.com");
...
}, "C:/Users/Tyson/Downloads/nosytlabs-github-ready/src/components/admin/AdminHeader.astro", void 0);const $$AdminDashboard = createComponent(($$result, $$props, $$slots) => {
...
}, "C:/Users/Tyson/Downloads/nosytlabs-github-ready/src/components/admin/AdminDashboard.astro", void 0);const $$Index$3 = createComponent(($$result, $$props, $$slots) => {
...
const $$url$3 = "/admin.html";const index$3=/*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({__proto__:null,default:$$Index$3,file:$$file$3,url:$$url$3},Symbol.toStringTag,{value:'Module'}));const $$Index$2 = createComponent(($$result, $$props, $$slots) => {
  const projects = [
    {
      id: "1",
      title: "NosytOS95",
...
const $$url$2 = "/admin/projects.html";const index$2=/*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({__proto__:null,default:$$Index$2,file:$$file$2,url:$$url$2},Symbol.toStringTag,{value:'Module'}));const $$Index$1 = createComponent(($$result, $$props, $$slots) => {
  const blogPosts = [
    {
      id: "1",
...
const $$url$1 = "/admin/blog.html";const index$1=/*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({__proto__:null,default:$$Index$1,file:$$file$1,url:$$url$1},Symbol.toStringTag,{value:'Module'}));const $$Astro = createAstro("https://nosytlabs.com");
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const mdPosts = await Astro2.glob(/* #__PURE__ */ Object.assign({"./cursor-ai-revolutionizing-coding.md": () => import('./cursor-ai-revolutionizing-coding.md-7bfdba58.js'),"./cursor-ai.md": () => import('./cursor-ai.md-6a9ace40.js').then(n=>n.c),"./index.md": () => import('./index.md-70fae825.js'),"./roo-code-advanced-ai-coding.md": () => import('./roo-code-advanced-ai-coding.md-2e2d8cf5.js'),"./roo-code-windsurf-large-codebases.md": () => import('./roo-code-windsurf-large-codebases.md-14267a92.js'),"./roo-code-windsurf.md": () => import('./roo-code-windsurf.md-b7289e38.js'),"./roo-code.md": () => import('./roo-code.md-9107e7a9.js'),"./trae-ai-adaptive-coding.md": () => import('./trae-ai-adaptive-coding.md-055a8554.js'),"./trae-ai.md": () => import('./trae-ai.md-5d8b7e3c.js'),"./windsurf-navigating-large-codebases.md": () => import('./windsurf-navigating-large-codebases.md-0a04add9.js'),"./windsurf.md": () => import('./windsurf.md-cfd12235.js')}), () => "./*.md").then(
    (posts) => (
      // Filter out the index.md file
      posts.filter((post) => !post.url?.endsWith("/blog") && !post.url?.endsWith("/blog/"))
    )
  );
  const blogPosts = mdPosts.map((post) => {
    const frontmatter = post.frontmatter || {};
    const title = frontmatter.title || "Untitled Post";
    const excerpt = frontmatter.excerpt || "No excerpt available";
...
const $$url = "/blog.html";const index=/*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({__proto__:null,default:$$Index,file:$$file,url:$$url},Symbol.toStringTag,{value:'Module'}));export{index$3 as a,index$2 as b,index$1 as c,index as d,index$4 as i,projectsData as p};